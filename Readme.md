...
# Parsing + Configuration Script – cam177 - Rev. A

This **Parsing + Configuration** script is designed for the **cam177** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – cam177 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **cam177** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
